...
>
	<div
		...
		data-testid={`admin-houses.student-${student.studentId}.drag-handle`}
		class={[
	...
	>
		{#if multiSelect.selectionMode}
			<input
				...
				data-testid={`admin-houses.student-${student.studentId}.checkbox`}
			/>
		{/if}
		<GripVertical
			data-testid={`admin-houses.student-${student.studentId}.grip`}
