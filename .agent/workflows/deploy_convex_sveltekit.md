...
2. **Vercel Preview (Staging)** – Deploys to Vercel using the *development* Convex cloud instance (`convex dev`).
3. **Vercel Production** – Deploys to Vercel using the *production* Convex cloud instance.
